...
$investment_data = $investment->index();
        ...
        <div class="row">
            ...
            <div class="col-12">
                <table class="table table-striped table-secondary table-hover">
                        ...
                        <tbody>
                            <?php foreach($investment_data as $key => $investment) : ?>
                            <tr>
                                <td class="p-3"><?= $investment['name'] ?></td>
                                <td class="p-3"><?= $investment['amount'] ?></td>
                                <td class="p-3"><?= $investment['timestamp'] ?></td>
